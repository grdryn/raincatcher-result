...
describe("Result Remove Mediator Topic", function() {
  ...
  var syncRemoveTopic = "wfm:sync:remove:result";
  var doneSyncRemoveTopic = "done:wfm:sync:remove:result:resultid";
  var errorSyncRemoveTopic = "error:wfm:sync:remove:result:resultid";
