...
describe("Result Read Mediator Topic", function() {
  ...
  var syncReadTopic = "wfm:sync:read:result";
  var doneSyncReadTopic = "done:wfm:sync:read:result:resultid";
  var errorSyncReadTopic = "error:wfm:sync:read:result:resultid";
