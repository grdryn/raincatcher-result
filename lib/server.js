...
var ResultCloudDataTopics = require('fh-wfm-mediator/lib/topics');
var ResultCloudTopics = require('fh-wfm-mediator/lib/topics');

module.exports = function(mediator, app, mbaasApi) {
  //Used for cloud data storage topics
  var resultCloudDataTopics = new ResultCloudDataTopics(mediator);
  resultCloudDataTopics.prefix(config.cloudDataTopicPrefix).entity(config.datasetId);

  //Used for cloud topics
  var resultCloudTopics = new ResultCloudTopics(mediator);
